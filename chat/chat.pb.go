...
var file_chat_chat_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x32, 0x38, 0x0a, 0x0a, 0x43, 0x68, 0x61, 0x74, 0x53, 0x65,
...
var file_chat_chat_proto_depIdxs = []int32{
	0, // 0: chat.ChatSevice.SayHello:input_type -> chat.Message
	0, // 1: chat.ChatSevice.SayHello:output_type -> chat.Message
